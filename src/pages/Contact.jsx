                ...
                <div className="grid lg:grid-cols-2 gap-12 bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
                    ...
                    <div className="space-y-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+905322365797" className="text-gray-600 mt-1 block hover:text-[#12985a]">
                                            +90 (532) 236 57 97
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="h-64 rounded-xl overflow-hidden shadow-sm border border-gray-100">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3010.41141255489!2d29.151476612384766!3d41.01625427123005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cacf58ef01d7d9%3A0x2e559363c44840e7!2zxLB5aWxpayBBZMSxbcSxIFVsdXNsYXJhcmFzxLEgxLBuc2FuaSBZYXJkxLFtIERlcm5lxJ9p!5e0!3m2!1str!2str!4v1768905337506!5m2!1str!2str"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen=""
